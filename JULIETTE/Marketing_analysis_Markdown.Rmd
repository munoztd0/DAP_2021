...
+ In glm1, AcceptedCmpTotal is not significant. By performing an anova test, we see that glm1 and glm2 don't different significantly, so we can keep the simplest which is glm2.  
