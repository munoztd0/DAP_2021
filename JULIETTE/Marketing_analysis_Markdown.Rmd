...
# Marketing analysis 
<!-- this `<br>` is to add breaklines, use it to make it less suffocating -->
<br>
...
>>>>>>> 358b61172573a8471ea7704ed00b42bc57b4fb09
...
<!-- Refer to the real name of variblke instead of abbreviation -->
...
<!-- Here, skewness appears to be 0,7 which is at an acceptable level. NO, you should say something more like: Skewness is quite high (0.7) BUT remains tolerable since this data is intrisincally skewed (no negative values possible), we will keep that in mind while making the model assumtpion checks ..-->
...
<!-- , people probably don't respond. We can safely remove these outliers. -->
<!-- more like:  people didn't respond. We CHOOSE to remove these responses because we think they where not responding truthfully OR anything like thjat. -->
...
<!-- : filtering the variables to keep by choosing best AIC | integrate that into the above senmtence-->
```{r}
...
=======
**A.6. Checking for interferences**
We first use the eta_squared function : everything that has 0.00 on the left of the 90% CI column has a "meaningless" effect size, but we still keep them on the model.
>>>>>>> 2470a4f (added stuff stadard poaramters)
...
<!-- but we still keep them on the model. -->
...
>>>>>>> 823e7fc6feafb7f0c0795164163160a6f9abd966
=======
>>>>>>> 358b61172573a8471ea7704ed00b42bc57b4fb09
```
<!--add comments -->
...
sjPlot::tab_model(effectsize::standardize(finalm1), rm.terms = c("*Education.Q", "Education^4", "Income:Education.C", "Education.Q" , "Kidhomeyes:Education.Q", "Income:Education.Q", "Kidhomeyes:Income:Education.Q", "Education.C" ,              "Kidhomeyes:Education.C"  ,      "Income:Education.C"  ,"Kidhomeyes:Income:Education.C", "Education^4",  "Kidhomeyes:Education^4", "Income:Education^4" , "Kidhomeyes:Income:Education^4"), show.intercept = F)  #what is this for? # this to show all the STANDARDIZED estimates on a numeric form in a table summarizing all thE information
```
<!--add comments for example the Rsquared is good-->
