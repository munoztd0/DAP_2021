...
remaining 30%. Using the formula `Group ~ . - Age - Gender` results in the best performance.
...
The performance of this simple model of `r accuracy`% is interesting, especially when inspecting the
