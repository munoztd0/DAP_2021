...
pacman::p_load(
  ...
  ggpubr, nnet, patchwork, stargazer
)
...
```{R, multiple linear regression model evaluation}
model.binom.1 <- glm(
  data=df.binom, 
...
anova(model.binom.1, model.binom.2, test ="Chisq")
# Gender and STRR sign and AIC 96.5
```

```{r models general table, results = 'asis', echo = FALSE}
stargazer(
  model.binom.1, model.binom.2,
  title="Comparison of generalised linear models",
