...
#On this analysis, we focus on the control self rating of the emotion elicitation that were answered at the presentation of the words.
#DV: affective ratings on a Likert scale
#IV1: Gender (F or M)
#IV2: the emotion (Disgust, fear or neutral)
#not used IVs: memory tasks
#question: How gender and emotion of words influence affective ratings
...
#DV: heart rate, breath rate and heart variance rate
