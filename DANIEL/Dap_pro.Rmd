...
pacman::p_load(here, ggplot2, rstatix, ordinal,stargazer, RVAideMemoire,sjPlot, HH, likert, dplyr)
...
## Pretty Plot
plot(likert(summary = df),legend.position="top")+ guides (fill = guide_legend(title="Subjective evaluation"))
```
...
sjPlot::plot_model(m2.2, type="diag")
