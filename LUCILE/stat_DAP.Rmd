...
temppath <- tempdir()
knitr::opts_chunk$set(fig.path = temppath)
...
pacman::p_load(GGally, ggfortify, ggplot2, MASS, here, kableExtra)
```
...
![image of a fine needle aspirate (FNA) of a breast mass](https://static-01.hindawi.com/articles/pri/volume-2011/547580/figures/547580.fig.001.jpg){style="float: center;margin-right: 7px; margin-left: 7px;margin-top: 7px; width:40%;"}
