...
![image of a fine needle aspirate (FNA) of a breast mass](a-b-Fine-needle-aspiration-cytology-of-the-breast-lesion-showed-singly-lying.png.jpeg){width=40%}
...
pacman::p_load(GGally, ggfortify, ggplot2, MASS, here)
```
