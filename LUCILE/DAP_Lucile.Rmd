...
One of the biggest causes of mortality among women is breast cancer ( cf pdf)
 diagnose as soon as possible can but it is quiet difficult due to the complexity and diversity of this disease. 
 
 def
 According to https://www.cancer.gov/publications/dictionaries/cancer-terms/def/tumor, a tumor is "An abnormal mass of tissue that forms when cells grow and divide more than they should or do not die when they should. Tumors may be benign (not cancer) or malignant (cancer). Benign tumors may grow large but do not spread into, or invade, nearby tissues or other parts of the body. Malignant tumors can spread into, or invade, nearby tissues"
 Specifically, breast cancer is a malignant tumor located in breast cells of the fatty tissues or the fibrous connective tissues within the breast.  
 https://www.breastcancer.org/symptoms/understand_bc/what_is_bc
 
The problem is to diagnose the severity of the breast 
Determine quickly and with precision the severity of a cancer is a critical point
  
## 1. Information about the dataset 
We propose to study the Wisconsin Breast Cancer Dataset. 

"Fine needle aspiration is a type of biopsy procedure. In fine needle aspiration, a thin needle is inserted into an area of abnormal-appearing tissue or body fluid." https://www.webmd.com/a-to-z-guides/fine-needle-aspiration

"Features are computed from a digitized image of a fine needle aspirate (FNA) of a breast mass. They describe characteristics of the cell nuclei present in the image. "

![Benign and malignant tumor (FNA) of a breast mass](benign_malignant.png){style="float: center;margin-right: 7px; margin-left: 7px;margin-top: 7px; width:60%;"}
...
## 3. Choice of data 
There is a lot of data, we choose only the data concerning the mean. The following analysis has been done 
