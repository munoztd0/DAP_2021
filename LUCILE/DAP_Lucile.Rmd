...
See in annex another GLM modelization with glmnet. 
...
* In the "Cook's distance" plot there is no observation with a high influence on the model: all distances are smaller than 0.5.
