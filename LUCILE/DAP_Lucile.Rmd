...
![fine needle aspirate (FNA) of a breast mass](fig1.jpg){style="float: center;margin-right: 7px; margin-left: 7px;margin-top: 7px; width:40%;"}
...
First, let's separate the data into train and test set. ( This will permit to be more accurrate when we test the goodness of the model)
...
pander(confusion.glmnet(cvfit, newx =as.matrix(x_test), newy = y_test, s = 'lambda.min'))
