...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Specify directory for figure output in a temporary directory}
\NormalTok{temppath }\OtherTok{\textless{}{-}} \FunctionTok{tempdir}\NormalTok{()}
\NormalTok{knitr}\SpecialCharTok{::}\NormalTok{opts\_chunk}\SpecialCharTok{$}\FunctionTok{set}\NormalTok{(}\AttributeTok{fig.path =}\NormalTok{ temppath)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pacman}\SpecialCharTok{::}\FunctionTok{p\_load}\NormalTok{(GGally, ggfortify, ggplot2, MASS, here, kableExtra)}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\includegraphics{https://static-01.hindawi.com/articles/pri/volume-2011/547580/figures/547580.fig.001.jpg}
...
\includegraphics{/tmp/RtmpTdjpUkunnamed-chunk-6-1.pdf}
...
\includegraphics{/tmp/RtmpTdjpUkunnamed-chunk-7-1.pdf} Even if
...
\includegraphics{/tmp/RtmpTdjpUkunnamed-chunk-14-1.pdf}
...
\includegraphics{/tmp/RtmpTdjpUkunnamed-chunk-14-2.pdf}
